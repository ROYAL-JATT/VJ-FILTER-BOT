...
BOT_TOKEN = environ.get('BOT_TOKEN', "6425089046:AAHLNDVmS_c1eTi12SI_vXZbLQacxja83NA")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002010665754'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6651109872').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002010665754').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002010665754') # give your force subscribe channel id here else leave it blank
auth_grp = environ.get('AUTH_GROUP', '-1002010665754') # give your force subscribe group id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002010665754')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002010665754')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002010665754')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Krishna:pss968048@cluster0.4rfuzro.mongodb.net/?retryWrites=true&w=majority")
